...
# defines the word lookup data frame; 
# adds a new variable to CDI data frame indicating session order of cross-sectional and longitudinal data; 
# calculates child's age in days and months and adds them as variables.
...
CDI <- select(CDI, PID, c_agemos, DOB, session_date, session, CDI_item, measurement)
