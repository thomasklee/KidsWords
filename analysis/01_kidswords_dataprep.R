...
# downloaded from the KidsWords website back-end in order 
# anonymise participants' identity.

# The script also removes data of paricipants in the
# Learning to Talk project that were manually added to 
# kidswords.org by research assistants, since these won't
# be used for the CDI normative study. It also removes records 
# from the website's test phase.

# -----------------------------------------------
# The 3 original data files (below) will not be 
# uploaded to GitHub or any other data repository
# since they contain names of participants. 
# Eventually, the 2 CSV files generated by this 
# script will be uploaded.
# -----------------------------------------------
